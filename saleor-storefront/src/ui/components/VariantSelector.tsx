							...
							<LinkWithChannel
								...
								className={clsx(
									isCurrentVariant
										...
										: "bg-white hover:border-gray-500 hover:bg-gray-100",
									"flex min-w-[5ch] items-center justify-center text-ellipsis whitespace-nowrap rounded border p-3 text-center text-sm font-semibold focus-within:outline-none aria-disabled:cursor-not-allowed aria-disabled:bg-neutral-100 aria-disabled:text-neutral-800 aria-disabled:opacity-50",
